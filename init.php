<?php
  ...
  License: GPL3
      ...
      AVS Metaboxes version 0.4, Copyright (C) 2016-2017 Alberto de Vera Sevilla
  ...
  */
  ...
  add_action('admin_enqueue_scripts',function(){
    ...
    wp_register_script('avs-metaboxes-functions',AVS_METABOXES_URL.'/assets/functions.js',array('jquery', 'wp-color-picker', 'jquery-ui-datepicker'), '1.0', true);
